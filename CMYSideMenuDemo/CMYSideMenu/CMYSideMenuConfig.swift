...
public enum CMYSideMenuAnimationType:Int {
    case zoom //缩放
    case translationPush //横向平移
    case translationMask //盖在最上面横向平移
}

public enum CMYSideMenuDirection:Int {
    case left  // 从左边出来
    case right // 从右边出来
}

public class CMYSideMenuConfig: NSObject {
    ...
    /// 侧边来出来的的方向 默认从左边出来
    public var direction:CMYSideMenuDirection! = .left
    
    /// 侧边来出来的动画方式
    public var animationType:CMYSideMenuAnimationType! = .translationPush {
        didSet {
